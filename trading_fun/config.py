...
class ModelConfig:
    ...
    feature_names: List[str] = field(default_factory=lambda: [
        "SMA50", "SMA200", "RSI", "Volatility", "Momentum_10d",
...
class MarketConfig:
    ...
    country_seeds: Dict[str, List[str]] = field(default_factory=lambda: {
        "Switzerland": [
            ...
            "VACN.SW", "BEAN.SW", "AREN.SW", "DUFN.SW", "TEMN.SW"
        ],
        "Germany": [
            "SAP", "SIE.DE", "ALV.DE", "DTE.DE", "VOW3.DE", "MBG.DE", "BMW.DE",
            "BAS.DE", "ADS.DE", "MUV2.DE", "BAYN.DE", "EOAN.DE", "DB1.DE",
            "HEN3.DE", "IFX.DE", "RHM.DE", "DAI.DE", "FRE.DE", "SHL.DE",
            "CON.DE", "BEI.DE", "VNA.DE", "SAP.DE", "P911.DE", "HNR1.DE"
        ],
        "United Kingdom": [
    ...
    country_indices: Dict[str, str] = field(default_factory=lambda: {
        "Switzerland": "^SSMI",
        "Germany": "^GDAXI",
        "United Kingdom": "^FTSE",
        "France": "^FCHI",
