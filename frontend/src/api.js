...
export const api = {
  ...
  getTickerInfoBatch: (tickers) => apiClient.post("/ticker_info_batch", tickers),
  ...
  createSimulation: (data) => apiClient.post("/api/simulations", data),

  getSimulation: (simulationId) => apiClient.get(`/api/simulations/${simulationId}`),
  ...
  getSimulationHistory: (simulationId) => apiClient.get(`/api/simulations/${simulationId}/history`),

  resetSimulation: (simulationId) => apiClient.post(`/api/simulations/${simulationId}/reset`),

  deleteSimulation: (simulationId) => apiClient.delete(`/api/simulations/${simulationId}`),
};
