...
function CryptoPortfolio({
  ...
  const paginatedResults = cryptoResults.slice(
    (cryptoPage - 1) * cryptoPerPage,
    cryptoPage * cryptoPerPage
  );
              ...
              <table aria-label="Digital assets and cryptocurrency rankings table">
                ...
                <tbody>
                  {paginatedResults.map((crypto, idx) => {
                    ...
                    const changeClass =
                      crypto.change_24h > 0 ? "positive" : crypto.change_24h < 0 ? "negative" : "";
                    const change7dClass =
                      crypto.change_7d > 0 ? "positive" : crypto.change_7d < 0 ? "negative" : "";
                    ...
                    return (
                      ...
                      >
                        <td>
                          <span className={actualRank <= 3 ? "rank-badge gold" : "rank-badge"}>
                            {actualRank}
                          </span>
                        </td>
                        <td>
                        ...
                        <td>
                          <Tooltip
                            ...
                            position="top"
                          >
                            {crypto.volume_to_mcap_ratio
                              ? `${crypto.volume_to_mcap_ratio.toFixed(2)}%`
                              : "N/A"}
                          </Tooltip>
                        </td>
                      </tr>
...
CryptoPortfolio.propTypes = {
  cryptoResults: PropTypes.arrayOf(
    PropTypes.shape({
