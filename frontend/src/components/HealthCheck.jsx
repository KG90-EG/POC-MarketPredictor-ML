  ...
  return (
    <div className="health-overlay" onClick={onClose}>
      <div className="health-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="health-item">
          <div className="health-item-header">
            <span className="health-icon" style={{ color: getStatusColor(health?.model_loaded) }}>
        ...
        <div className="health-item">
          <div className="health-item-header">
            <span className="health-icon" style={{ color: getStatusColor(health?.openai_available) }}>
        ...
        <div className="health-item">
          <div className="health-item-header">
            <span className="health-icon" style={{ color: getStatusColor(health?.redis_status || health?.cache_backend) }}>
              {getStatusIcon(health?.redis_status === 'connected' || health?.cache_backend === 'redis')}
            </span>
