        ...
        {crypto.loading ? (
          ...
          <div className="sidebar-content">
            ...
            >
              ...
              <div>
                <h2 id="sidebar-title" style={{ margin: 0 }}>
            ...
            <div className="detail-section">
              ...
              <p className="probability">
                Momentum Score:{" "}
                {crypto.momentum_score ? `${crypto.momentum_score.toFixed(2)}%` : "N/A"}
              </p>
            </div>
            ...
            <div className="detail-section">
              ...
              <div className="detail-grid">
                <div className="detail-item">
                  ...
                  <span className="detail-value">{formatPrice(crypto.price)}</span>
                </div>
                <div className="detail-item">
            ...
            <div className="detail-section">
              ...
              <PriceChart data={priceHistory} width={400} height={200} color="#f59e0b" />
            </div>
