...
from src.trading_engine.ml.feature_engineering import get_feature_names
from src.trading_engine.ml.trading import USE_ALL_FEATURES, build_dataset, train_model
...
def test_model_training():
    ...
    try:
        ...
        model, metrics = train_model(data, model_type="xgb", use_feature_selection=True, n_features=30)
