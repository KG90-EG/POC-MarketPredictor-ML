    ...
    def get_ticker_info(ticker: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "change": (
                    float(current_price - prev_close) if current_price and prev_close else None
                ),
...
class HealthService:
    ...
    def check_model_health() -> Dict[str, Any]:
        ...
        return {"model_loaded": os.path.exists(model_path), "model_path": model_path}
    ...
    def check_cache_health() -> Dict[str, Any]:
        ...
        return {"cache_backend": cache_backend, "redis_status": redis_status}
