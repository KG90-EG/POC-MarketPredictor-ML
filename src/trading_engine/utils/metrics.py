...
# Model metrics
model_predictions_total = Counter("model_predictions_total", "Total number of model predictions", ["model", "outcome"])

model_prediction_confidence = Histogram("model_prediction_confidence", "Model prediction confidence scores", ["model"])
...
# Business metrics
simulations_created_total = Counter("simulations_created_total", "Total number of simulations created")
