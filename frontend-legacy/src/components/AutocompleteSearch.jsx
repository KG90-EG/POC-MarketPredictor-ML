  ...
  return (
    <div className="autocomplete-wrapper" ref={wrapperRef}>
      ...
      {showSuggestions && filteredSuggestions.length > 0 && (
        <ul id="autocomplete-suggestions" className="autocomplete-suggestions" role="listbox">
          {filteredSuggestions.map((suggestion, index) => {
            ...
            return (
              ...
              >
                ...
                {suggestion.sector && <div className="suggestion-sector">{suggestion.sector}</div>}
                {suggestion.price && (
